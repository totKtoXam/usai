...
docs/ai-workflows/modules/{module-name}/features/{yyyyMMdd-HHmm}-{feature-name}/final.md
docs/ai-workflows/modules/{module-name}/features/{yyyyMMdd-HHmm}-{feature-name}/completion-report.md
docs/ai-workflows/modules/{module-name}/features/{yyyyMMdd-HHmm}-{feature-name}/handoff.md
```
